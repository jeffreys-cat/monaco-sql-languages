...
export declare class MySqlParserVisitor<Result> extends AbstractParseTreeVisitor<Result> {
	...
	visitTableOptionSecondaryEngineAttribute?: (
		ctx: TableOptionSecondaryEngineAttributeContext
	) => Result;
	/**
	...
	visitAlterByAlterCheckTableConstraint?: (
		ctx: AlterByAlterCheckTableConstraintContext
	) => Result;
	/**
	 ...
	 * @return the visitor result
	 */
	visitReplaceStatementValuesOrSelectOrTable?: (
	...
	visitDiagnosticsConditionInformationName?: (
		ctx: DiagnosticsConditionInformationNameContext
	) => Result;
	/**
