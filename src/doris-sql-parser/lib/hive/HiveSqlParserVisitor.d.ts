...
export declare class HiveSqlParserVisitor<Result> extends AbstractParseTreeVisitor<Result> {
	 ...
	 * @return the visitor result
	 */
	visitCreateTablePartitionColumnTypeSpec?: (
	 ...
	 * @return the visitor result
	 */
	visitTableRowFormatCollItemsIdentifier?: (
	 ...
	 * @return the visitor result
	 */
	visitPrecedencePlusExpressionOrDefault?: (
	 ...
	 * @return the visitor result
	 */
	visitAlterTblPartitionStatementSuffix?: (
		ctx: AlterTblPartitionStatementSuffixContext
	) => Result;
	/**
	 ...
	 * @return the visitor result
	 */
	visitAlterDataConnectorStatementSuffix?: (
	 ...
	 * @return the visitor result
	 */
	visitAlterStatementSuffixDropPartitions?: (
	 ...
	 * @return the visitor result
	 */
	visitPrecedenceSimilarExpressionPartNot?: (
	 ...
	 * @return the visitor result
	 */
	visitSql11ReservedKeywordsUsedAsFunctionName?: (
