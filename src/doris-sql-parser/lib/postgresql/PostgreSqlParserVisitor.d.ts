...
export declare class PostgreSqlParserVisitor<Result> extends AbstractParseTreeVisitor<Result> {
	 ...
	 * @return the visitor result
	 */
	visitNonreservedword_or_sconst_column?: (
		ctx: Nonreservedword_or_sconst_columnContext
	) => Result;
	/**
	...
	visitAlter_identity_column_option_list?: (
		ctx: Alter_identity_column_option_listContext
	) => Result;
	/**
	...
	visitSet_operator_with_all_or_distinct?: (
		ctx: Set_operator_with_all_or_distinctContext
	) => Result;
	/**
