...
export declare class SparkSqlParserVisitor<Result> extends AbstractParseTreeVisitor<Result> {
	 ...
	 * @return the visitor result
	 */
	visitFunctionTableNamedArgumentExpression?: (
	 ...
	 * @return the visitor result
	 */
	visitQualifiedColTypeWithPositionSeqForAdd?: (
	 ...
	 * @return the visitor result
	 */
	visitQualifiedColTypeWithPositionForAdd?: (
	 ...
	 * @return the visitor result
	 */
	visitQualifiedColTypeWithPositionSeqForReplace?: (
	 ...
	 * @return the visitor result
	 */
	visitQualifiedColTypeWithPositionForReplace?: (
	 ...
	 * @return the visitor result
	 */
	visitColDefinitionDescriptorWithPosition?: (
